...
if "site_types_mixed" in df_filt.columns:
    ...
    ax.legend(fontsize=17.5, loc="upper left", bbox_to_anchor=(0.18, 1.1), ncol=3, frameon=True, borderaxespad=0.1)
...
if df_main_path.exists():
    ...
    SCATTER_KW_WSEP["style_legend_anchor"] = (0.325, -0.06)
...
for ele in LIGHT_ELEMENTS:
    ...
    if show_legend:
        ax.legend(fontsize=20, loc="upper center", bbox_to_anchor=(0.42, 1.0))
